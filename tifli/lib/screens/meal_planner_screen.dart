...
class MealPlannerScreenV2 extends StatefulWidget {
  const MealPlannerScreenV2({Key? key}) : super(key: key);
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(id == null ? 'Add Meal' : 'Edit Meal', style: AppFonts.heading1),
                        ...
                        onPressed: () {
                          ...
                          setState(() {
                            ...
                            if (id == null) {
                              ...
                              final idx = _mealsByDate[normalized]!.indexWhere((m) => m['id'] == id);
                              if (idx != -1) {
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(ctx);
                  Navigator.pushNamed(context, '/meal-details', arguments: {'id': id});
                },
              ),
            ],
          ),
        ...
        children: [
          ...
          Row(
            ...
            children: List.generate(7, (index) {
              ...
              final isSelected = _normalizeDate(day) == _normalizeDate(_selectedDate);
...
class MealCardV2 extends StatelessWidget {
  ...
  const MealCardV2({Key? key, required this.meal, this.onCheck, this.onMore, this.onTap}) : super(key: key);
          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                height: 44,
                decoration: BoxDecoration(
                  color: meal['checked'] ? AppColors.primary : AppColors.backgroundLight,
                  borderRadius: BorderRadius.circular(AppSizes.radiusSm),
                  border: Border.all(color: meal['checked'] ? AppColors.primary : AppColors.primary.withOpacity(0.12)),
                ),
                child: meal['checked'] ? const Icon(Icons.check, color: Colors.white) : null,
              ),
            ),
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(meal['title'], style: AppFonts.body?.copyWith(fontWeight: FontWeight.w700)),
                  const SizedBox(height: AppSizes.xs),
                  Text(meal['subtitle'], style: AppFonts.body?.copyWith(color: AppColors.textPrimaryLight)),
                ],
              ),
            ),
            const SizedBox(width: AppSizes.sm),
            Container(
              ...
              child: IconButton(icon: Icon(Icons.more_horiz, color: AppColors.primary), onPressed: onMore),
            ),
          ],
        ),
      ),
